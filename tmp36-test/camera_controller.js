...
const fs = require("fs"),
    ...
    localIp = require('ip'),
    PiCamera = require('./config/camera_config.js'),
    program = require('commander'),
    pjson = require('./package.json');

program
  .version(pjson.version)
  .description(pjson.description2)
...
var port = program.port || process.env.CAMERA_PORT,
    width = program.width || 640,
    height = program.height || 480,
    timeout = program.timeout || 50,
    quality = program.quality || 25,
    tmpFolder = os.tmpdir(),
